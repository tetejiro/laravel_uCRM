                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        ...
                        <div class="relative py-5">
                          ...
                          <label>予約可能<input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" class="mx-1"></label>
                          <label class="px-3">予約不可<input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="0" class="mx-1"></label>
                        </div>
                      </div>
                      <div class="p-2 w-full">
